...
<h2>ご注文内容</h2>
<form method="post" id="confirm" name="confirm" action="confirm.php">
...
<tr>
<td><input type="text" placeholder="チキン竜田生姜焼き弁当">&nbsp;<input class="w50" type="button" value="取消"></td>
<td class="order_number"><input class="w30" type="number" min="1">&nbsp;個</td>
<td class="order_price">630円</td>
</tr>

<tr>
<td colspan="3"><a href="#">+商品を追加する</a></td>
</tr>
...
<br>
<p class="btn_link"><input type="submit" id="confirm" name="confirm" value="内容確認画面へ" onClick="return chkInput();" /></p>
</form>
